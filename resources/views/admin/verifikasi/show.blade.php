...
<div class="row g-3">
    <div class="col-md-8">
                ...
                <div class="d-flex gap-3 align-items-start">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="d-flex gap-2 flex-wrap">
                            <span style="background:rgba(200,146,42,0.1);color:#7a5c1e;padding:2px 8px;border-radius:2px;font-size:0.72rem;font-weight:500;">
                            ...
                            <span style="font-size:0.72rem;background:#f4f0e8;color:#6b7280;padding:2px 8px;border-radius:2px;">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(100px,1fr));gap:8px;">
                    ...
                    <div style="aspect-ratio:1;border-radius:3px;overflow:hidden;background:#e8e0d4;cursor:pointer;"
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="mb-3">
                    <div style="font-size:0.68rem;font-weight:700;text-transform:uppercase;letter-spacing:0.1em;color:#9ca3af;margin-bottom:6px;">Deskripsi Umum</div>
                    <p style="font-size:0.88rem;line-height:1.8;color:#374151;">{{ $laporan->deskripsi_umum }}</p>
                </div>
                @if($laporan->sejarah_asal_usul)
                <div class="mb-3">
                    <div style="font-size:0.68rem;font-weight:700;text-transform:uppercase;letter-spacing:0.1em;color:#9ca3af;margin-bottom:6px;">Sejarah & Asal-Usul</div>
                    <p style="font-size:0.88rem;line-height:1.8;color:#374151;">{{ $laporan->sejarah_asal_usul }}</p>
                </div>
                @endif
                @if($laporan->nilai_makna_budaya)
                <div>
                    <div style="font-size:0.68rem;font-weight:700;text-transform:uppercase;letter-spacing:0.1em;color:#9ca3af;margin-bottom:6px;">Nilai & Makna Budaya</div>
                    <p style="font-size:0.88rem;line-height:1.8;color:#374151;">{{ $laporan->nilai_makna_budaya }}</p>
                </div>
                @endif
            </div>
        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div style="background:rgba(45,90,39,0.05);border:1px solid rgba(45,90,39,0.2);border-radius:4px;padding:1.25rem;">
                            <div style="font-weight:600;color:#2D5A27;margin-bottom:8px;font-size:0.88rem;">
                                <i class="bi bi-check-circle me-2"></i>Setujui Laporan
                            </div>
                            <p style="font-size:0.78rem;color:#6b7280;margin-bottom:12px;">OPK akan masuk peta resmi & dashboard Pemkab Badung.</p>
                    ...
                    <div class="col-md-6">
                        <div style="background:rgba(192,57,43,0.05);border:1px solid rgba(192,57,43,0.2);border-radius:4px;padding:1.25rem;">
                            <div style="font-weight:600;color:#C0392B;margin-bottom:8px;font-size:0.88rem;">
                                <i class="bi bi-x-circle me-2"></i>Tolak Laporan
                            </div>
                            <p style="font-size:0.78rem;color:#6b7280;margin-bottom:12px;">Laporan ditolak dan pelapor akan diberitahu.</p>
    ...
    <div class="col-md-4">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body p-0">
                ...
                <div style="padding:1rem;">
                    ...
                    @if($v)<div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid #f0ebe3;font-size:0.78rem;"><span style="color:#9ca3af;width:100px;flex-shrink:0;">{{ $k }}</span><span style="font-weight:500;text-align:right;word-break:break-all;">{{ $v }}</span></div>@endif
                    @endforeach
                </div>
            </div>
        </div>
        ...
        <div class="card mb-3">
            ...
            <div class="card-body p-0"><div style="padding:0 1rem;">
                ...
                @if($v)<div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid #f0ebe3;font-size:0.78rem;"><span style="color:#9ca3af;width:100px;flex-shrink:0;">{{ $k }}</span><span style="font-weight:500;text-align:right;">{{ $v }}</span></div>@endif
                @endforeach
            </div></div>
        </div>
        ...
        <div class="card mb-3">
            ...
            <div class="card-body p-0"><div style="padding:0 1rem;">
                ...
                @if($v)<div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid #f0ebe3;font-size:0.78rem;"><span style="color:#9ca3af;width:80px;flex-shrink:0;">{{ $k }}</span><span style="font-weight:500;text-align:right;word-break:break-all;">{{ $v }}</span></div>@endif
                @endforeach
            </div></div>
        </div>
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <a href="{{ asset('storage/'.$dok->path) }}" target="_blank"
                   ...
                   style="background:#fdfaf5;border:1px solid #e5e0d8;color:var(--tanah);">
                    <i class="bi bi-file-earmark-pdf" style="color:#c0392b;"></i>
                    <span style="font-size:0.78rem;flex:1;">{{ $dok->nama_file }}</span>
                    <i class="bi bi-download" style="font-size:0.75rem;color:#9ca3af;"></i>
                </a>
                @endforeach
            </div>
        </div>
