...
class StoreLaporanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'fotos.*'              => 'image|mimes:jpg,jpeg,png,heic|max:2048',
    ...
    public function messages(): array
    {
        return [
            ...
            'fotos.*.uploaded'         => 'Foto gagal diupload. Pastikan ukuran file tidak melebihi 2MB.',
            'fotos.*.max'              => 'Ukuran foto maksimal 2MB.',
            'fotos.max'                => 'Maksimal 10 foto yang dapat diupload.',
            'dokumen.max'              => 'Ukuran dokumen maksimal 2MB.',
            'dokumen.uploaded'         => 'Dokumen gagal diupload. Pastikan ukuran file tidak melebihi 2MB.',
